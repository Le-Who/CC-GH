...
const PetCompanionImpl = (function () {
  ...
  function renderInfoPanel() {
    ...
    panel.innerHTML = `
      <button class="pet-info-close" aria-label="Close pet info" id="pet-info-close">✕</button>
      <div class="pet-info-header">
        <span class="pet-info-name">${SKINS[petData.skinId] || "🐕"} ${petData.name} <button class="btn btn-sm" aria-label="Rename pet" id="btn-rename-pet" style="padding: 2px 6px; font-size: 0.7rem; margin-left: 6px; background: rgba(255,255,255,0.1);">✏️</button></span>
