...
const translations = {
  en: {
    ...
    'quest.close': 'Close garden quests',
  ...
  ru: {
    ...
    'quest.close': 'Закрыть квесты сада',
    'quest.progress': '{current}/{target}',
    'quest.claim': 'Забрать',
