...
const APP_TRANSLATIONS = {
  en: {
    ...
    "pause.mergeIntro": "Merge matching items to upgrade them. Resume keeps the board and the current Merge or Trash mode.",
  ...
  ru: {
    ...
    "pause.mergeIntro": "Соединяйте одинаковые предметы, чтобы улучшать их. Возврат сохраняет поле и режим слияния или удаления.",
