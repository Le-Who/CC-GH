...
export default function HUD({ onOpenStore, onOpenQuest }) {
  ...
  const shared = slices.shared || { energy: 30, maxEnergy: 30, gold: 0, activeQuests: 0 };
      ...
      <div className="flex gap-3 pointer-events-auto">
        ...
        >
          ...
          <span className="relative z-10 font-heading font-bold text-white tracking-wide">
            {shared.energy}<span className="text-textDim text-sm">/{shared.maxEnergy}</span>
          </span>
        </motion.div>
        ...
        >
          ...
          <motion.span 
            key={shared.gold}
            className="font-heading font-bold text-gold tracking-wide"
